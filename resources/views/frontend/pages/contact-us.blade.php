            ...
            <section class="contact-section">
                <div class="container">
                                ...
                                <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
                                    <div
                                        ...
                                        style="
                                            ...
                                            border-width: 0px;
                                            margin: 0px;
                                            cursor: url(_https_/maps.gstatic.com/mapfiles/openhand_8_8.html), default;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <form class="form-contact contact_form" action="https://technext.github.io/logisticexpress/contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                                <div class="row">
                                    <div class="col-12">
