                    ...
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{  asset('assets/frontend/img/logo/logo.png')}}" width="50px" alt=""></a>
                            </div>
                            <div class="footer-tittle">
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-lg-12">
                        <div class="footer-copy-right text-center">
                            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://maniwebify.com/" target="_blank">Maniwebify</a></p>
                        </div>
                    </div>
                </div>
            </div>
