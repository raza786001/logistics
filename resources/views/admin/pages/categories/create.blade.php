...
<!--Page content-->
                ...
                <div class="panel">
					    ...
					    <div class="panel-body">
					        ...
					        <!-- Inline Form  -->
					        <!--===================================================-->
					        <form class="form-inline" method="post" action="{{ url('admin/categories') }}" enctype='multipart/form-data'>
								@csrf
					            <div class="form-group">
					                <label for="demo-inline-inputmail" class="sr-only">Name</label>
					                <input type="text" placeholder="Enter Categories" name="name" id="demo-inline-inputmail" class="form-control">
					            </div>
					            <div class="form-group">
